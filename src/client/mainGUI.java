...
public class mainGUI extends JFrame implements WindowListener {
	...
	public mainGUI(String arg, int arg1, String name, String msg, int port_Server,String guest) throws Exception {
		IPClient = arg;
		portClient = arg1;
		nameGuest = guest;
		nameUser = name;
	...
	public mainGUI() throws Exception {
		...
		btnSaveServer.setIcon(new ImageIcon("D:\\apchat-main\\image\\diskette.png"));
...
//		contentPane.add(btntieptuc);
	...
	private void connectChat() {
		...
		int n = JOptionPane.showConfirmDialog(this,nameGuest + " có muốn kết nối với người này không?", "Kết nối",
